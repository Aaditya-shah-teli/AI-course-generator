    ...
    <div>
      ...
      <div className='px-10 md:px20 lg:px-44 mt-10'>
        ...
        <div className=' mt-10 flex justify-between'>
          <Button className='' disabled={activeIndex === 0} onClick={() => setActiveIndex(activeIndex - 1)} variant={'outline'}>Previous</Button>
          {activeIndex < 2 && <Button className='bg-purple-400' onClick={() => setActiveIndex(activeIndex + 1)}>Next</Button>}
          {activeIndex == 2 && <Button className='bg-purple-400' >Generate Course Layout</Button>}
        </div>
      </div>
    </div>)
}
